 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Visono_Sniffs_NamingConventions_ValidVariableNameSniff extends PHP_CodeSniffer_Standards_AbstractVariableSniff
{
	...
	protected $strictCamelCase = true;
	...
	protected function processVariable(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
	{
		...
		if ($tokens[$objOperator]['code'] === T_OBJECT_OPERATOR) {
			...
			if ($tokens[$var]['code'] === T_STRING) {
				...
				if ($tokens[$bracket]['code'] !== T_OPEN_PARENTHESIS) {
					...
					if (PHP_CodeSniffer::isCamelCaps($objVarName, false, true, $this->strictCamelCase) === false) {
		...
		if (PHP_CodeSniffer::isCamelCaps($varName, false, true, $this->strictCamelCase) === false) {
			$error = 'Variable "%s" is not in valid camel caps format';
			$data  = array($originalVarName);
	...
	protected function processMemberVar(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
	{
		...
		// isCamelCaps erwartet als drittes Parameter public oder nicht und wenn nicht dann will er einen "_" am
		// Anfang der Variable haben, das wollen wir nicht, deswegen wird true übergeben
		if (PHP_CodeSniffer::isCamelCaps($varName, false, true, $this->strictCamelCase) === false) {
			$error = 'Variable "%s" is not in valid camel caps format';
	...
	protected function processVariableInString(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
	{
		...
		if (preg_match_all($pattern, $tokens[$stackPtr]['content'], $matches) !== 0) {
